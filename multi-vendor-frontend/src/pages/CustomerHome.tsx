...
export default function CustomerHome() {
  ...
  return (
    <div style={{ animation: 'fadeIn 0.5s ease-out' }}>
      ...
      <div className="glass-container" style={{ maxWidth: '1200px', margin: '0 auto', padding: '2rem', background: 'transparent', boxShadow: 'none' }}>
        <h2 style={{ fontSize: '1.5rem', marginBottom: '1.5rem', fontWeight: 700 }}>Popular Restaurants</h2>
          ...
          {isLoading ? (
            ...
            restaurants.map((restaurant) => (
              <div 
                ...
                style={{ background: 'white', borderRadius: '16px', overflow: 'hidden', boxShadow: '0 4px 6px -1px rgba(0, 0, 0, 0.05)', cursor: 'pointer', transition: 'transform 0.2s', ...{ ':hover': { transform: 'translateY(-4px)' } } as any }}
              >
                <div style={{ 
                  height: '160px', 
                ...
                <div style={{ padding: '1.25rem' }}>
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '0.5rem' }}>
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '4px', background: '#fef3c7', color: '#d97706', padding: '2px 6px', borderRadius: '4px', fontSize: '0.875rem', fontWeight: 600 }}>
                      <Star size={14} fill="#d97706" /> {restaurant.rating}
                    </div>
                  </div>
